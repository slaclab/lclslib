...
#  $Id: SegGeometryEpix100V1.py 12247 2016-07-11 19:14:02Z dubrovin@SLAC.STANFORD.EDU $
#
# Description:
#  Module SegGeometryEpix100V1...
#------------------------------------------------------------------------

"""Class :py:class:`algos.geometry.SegGeometryEpix100V1` describes the Epix100 V1 sensor geometry.
...
Usage of interface methods::
    ...
    from algos.geometry.SegGeometryEpix100V1 import epix2x2_one as sg
...
@see :py:class:`algos.geometry.SegGeometry`
...
from algos.geometry.SegGeometry import *
...
if __name__ == "__main__" :
    import algos.graph.GlobalGraphics as gg # For test purpose in main only

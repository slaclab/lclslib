...
For example, CSPAD 2x1 sensor is implemented in class :py:class:`algos.geometry.SegGeometryCspad2x1V1`.
Access to all implemented sensors is available through the factory method in class :py:class:`algos.geometry.SegGeometryStore`.


Usage of interface methods::

    from algos.geometry.SegGeometryCspad2x1V1 import cspad2x1_one as sg
...
@see :py:class:`algos.geometry.SegGeometry`, :py:class:`algos.geometry.SegGeometryCspad2x1V1`, :py:class:`algos.geometry.SegGeometryStore`

...
Usage::
    ...
    from algos.geometry.GeometryAccess import GeometryAccess, img_from_pixel_arrays
...
@see :py:class:`algos.geometry.GeometryObject`, :py:class:`algos.geometry.SegGeometry`, :py:class:`algos.geometry.SegGeometryCspad2x1V1`, :py:class:`algos.geometry.SegGeometryStore`
...
@version $Id: GeometryAccess.py 12031 2016-06-06 21:57:34Z dubrovin@SLAC.STANFORD.EDU $

@author Mikhail S. Dubrovin
"""
#--------------------------------
__version__ = "$Revision: 12031 $"
#--------------------------------

import os
import sys
from algos.geometry.GeometryObject import GeometryObject
...
if __name__ == "__main__" :
    ...
    import algos.graph.GlobalGraphics as gg # for test purpose
    import algos.core.TestImageGenerator as tig # for test purpose only

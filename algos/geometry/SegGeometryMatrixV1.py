...
"""Class :py:class:`algos.geometry.SegGeometryMatrixV1` defines the matrix V1 (pnCCD, 512x512) sensor pixel coordinates in its local frame.
...
Usage of interface methods::
    ...
    from algos.geometry.SegGeometryMatrixV1 import cspad2x1_one as sg

#!/usr/bin/env python
#------------------------------
""":py:class:`algos.geometry.GeometryObject` - building block for hierarchical geometry

Usage::

    # Methods of this class are used internally in algos.geometry.GeometryAccess
...
@see :py:class:`algos.geometry.GeometryAccess`
...
#------------------------------
    ...
    def det_shape(self, arr) :
        ...
        """
        #print 'algos.geometry.GeometryObject.det_shape(...):  arr.size: %d   self.oname: %s' % (arr.size, self.oname)

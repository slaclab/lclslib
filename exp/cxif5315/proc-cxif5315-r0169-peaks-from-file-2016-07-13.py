...
def procPeakDataArc(pk) :
    ...
    """
    #===================
    # Pre-selection: discard from all histograms except its own
...
def procPeaksFromFile(fname, fname_lut, ofn_prefix='plot') :
    ...
    print 'Number of fitted  events: %d' % (sp.count_evt_fitted)
...
def do_main() :
    ...
    # Data peak list processing since 2016-04-20
    pfvers = 'xpfv3r1' # 'xpfv4r1', 'xpfv2r1'
    ...
    oprefix = '%s/plot-cxif5315-r0169-%s-2016-07-13-v01' % (rdir, pfvers)
